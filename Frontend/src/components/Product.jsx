  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        ...
        } else if (response.data.productImage) {
          const base64Image = response.data.productImage;
          if (base64Image.startsWith('data:')) {
            setImageUrl(base64Image);
          } else {
            setImageUrl(`data:image/jpeg;base64,${base64Image}`);
      ...
      <div className="row">
        ...
        <div className="col-md-6 mb-4">
          <div className="card border-0">
            <img
              src={imageUrl || (product.imageData ? `data:image/jpeg;base64,${product.imageData}` : (product.productImage ? `data:image/jpeg;base64,${product.productImage}` : "/fallback-image.jpg"))}
              alt={product.name}
